"""
Configuration for 100% CARLA-OpenLane scaling experiment (full dataset).
"""
...
scale_fraction = 1.0
sampling_method = 'full'  # Using full dataset
seed = 42
...
# Training schedule - full dataset may benefit from longer training
