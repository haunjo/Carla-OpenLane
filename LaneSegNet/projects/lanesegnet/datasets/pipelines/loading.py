...
@PIPELINES.register_module()
class LoadAnnotations3DLaneSegment(LoadAnnotations3D):
    ...
    def __init__(self,
        ...
        self.with_lane_text = with_lane_text
    ...
    def _load_lanes_3d(self, results):
        ...
        if self.with_lane_text:
            results['gt_lane_text_labels'] = results['ann_info']['gt_lane_text_labels']
        if self.with_area:
    ...
    def __repr__(self):
        ...
        repr_str += f'{indent_str}with_lane_text={self.with_lane_text}, '
