...
model = dict(
    ...
    lsls_head=dict(
        ...
        n_heads=1,  # Multi-head attention (H=4)
        loss_rel=dict(
            type='FocalLoss',
            use_sigmoid=True,
            gamma=2.0,
...
log_level = 'INFO'
work_dir = 'work_dirs/ablation_singlehead_h1_stage2'

# IMPORTANT: Load Stage 1 checkpoint
load_from = 'work_dirs/lanesegnet_1stage_text_supervision_mapele_bucket/latest.pth'
