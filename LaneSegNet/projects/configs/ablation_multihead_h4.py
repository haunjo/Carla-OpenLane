...
"""
Ablation Study: Multi-head Cross-Attention (H=4)

This config extends the baseline text-guided model with multi-head cross-attention.

Changes from baseline:
- n_heads=4 (instead of 1)
- Multi-head attention with 4 heads for diverse semantic aspects
- Same training schedule (8 epochs on Carla-OLV2)

Expected improvements:
- Better semantic coverage via multiple attention heads
- Each head captures different aspect (geometry, intersection context, direction, etc.)
"""
...
log_level = 'INFO'
work_dir = 'work_dirs/ablation_multihead_h4_stage1'
load_from = None
resume_from = None
workflow = [('train', 1)]
