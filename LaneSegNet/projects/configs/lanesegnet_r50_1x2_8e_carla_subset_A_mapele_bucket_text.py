...
"""
CARLA Stage 1 - Text-enhanced version
Text-guided topology reasoning with TextEnhancedRelationshipHead.

Multi-head approach:
- Deformable DETR for traffic element detection (13 classes)
- LaneSegNet head for lane segment detection
- TextEnhancedRelationshipHead for lane-lane topology reasoning
- RelationshipHead for lane-traffic element topology reasoning
...
model = dict(
    ...
    lsls_head=dict(
        ...
        loss_text=dict(
            type='CrossEntropyLoss',
            loss_weight=0.1)),  # Text supervision loss
    bbox_head=dict(
