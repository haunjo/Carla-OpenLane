...
log_level = 'INFO'
work_dir = None
load_from = None  # 'checkpoints/bevformer_r50_8x1_24e_nuscenes.pth'  #  'epoch_20.pth'  #  'checkpoints/bevformer_r50_8x1_24e_nuscenes.pth'  #  'epoch_20.pth'  # 'checkpoints/deformable_detr_r50_16x2_50e_coco-3d9f5b4a.pth'  #
resume_from = None
workflow = [('train', 1)]
