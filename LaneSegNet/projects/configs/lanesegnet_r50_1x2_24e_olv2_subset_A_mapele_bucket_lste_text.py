...
model = dict(
    ...
    lste_head=dict(
        ...
        freeze_text_proj=True,  # Train text components in Stage 1
        ...
        loss_rel=dict(
            ...
            alpha=0.25,
            loss_weight=5),
        loss_text=None),  # Reduced from 0.1 to 0.05 for stability
    area_head=dict(
        type='MapTRHead',
        bev_h=bev_h_,
        bev_w=bev_w_,
...
lr_config = dict(
    ...
    min_lr_ratio=1e-3)
total_epochs = 24
evaluation = dict(interval=24, start=22, pipeline=test_pipeline)
...
log_level = 'INFO'
work_dir = None
load_from = 'work_dirs/lanesegnet_lste_text_FIXED/epoch_8.pth'
resume_from = None
workflow = [('train', 1)]
